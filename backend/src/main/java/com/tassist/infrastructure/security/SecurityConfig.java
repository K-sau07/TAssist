...
/**
 * Real security configuration (§10). Stateless, JWT filter, bcrypt(12).
 * Public: /api/auth/**, /actuator/health. Everything else requires a valid JWT.
...
public class SecurityConfig {
    ...
    public PasswordEncoder passwordEncoder() {
        return new BCryptPasswordEncoder(12); // §10: bcrypt strength 12
    }
}
